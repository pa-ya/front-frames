  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        { type: "code", lang: "ts", code: "// Redux Toolkit — a slice: reducers + actions generated for you\nimport { configureStore, createSlice } from \"@reduxjs/toolkit\";\n\nconst counter = createSlice({\n  name: \"counter\",\n  initialState: { value: 0 },\n  reducers: { inc: (s) => { s.value += 1; } },   // Immer lets you \"mutate\" safely\n});\nexport const store = configureStore({ reducer: { counter: counter.reducer } });\n// components: useSelector((s) => s.counter.value) + useDispatch()" },

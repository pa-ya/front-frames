  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        { type: "code", lang: "go", code: "tb := widget.NewToolbar(\n\twidget.NewToolbarAction(theme.DocumentCreateIcon(), func() {}),\n\twidget.NewToolbarSeparator(),\n\twidget.NewToolbarSpacer(),\n\twidget.NewToolbarAction(theme.SettingsIcon(), func() {}),\n)" }
      ]
    },
    {
      id: "layouts",
    ...
    },
    {
      ...
      body: [
        ...
        { type: "code", lang: "go", code: "//go:embed Inter-Regular.ttf\nvar interTTF []byte\nvar interFont = fyne.NewStaticResource(\"Inter-Regular.ttf\", interTTF)\n\nfunc (m myTheme) Font(s fyne.TextStyle) fyne.Resource {\n\tif !s.Bold && !s.Italic && !s.Monospace { return interFont }\n\treturn m.Theme.Font(s)\n}" },
        { type: "callout", variant: "tip", text: "There is no per-widget `style=` / CSS. To restyle one widget differently you either wrap it in `container.NewThemeOverride` (core Fyne, `fyne.io/fyne/v2/container`, since ~v2.5), swap the whole app theme, or build a custom widget. Individual color tweaks usually mean overriding a `ColorName` app-wide." }
      ]
    },
    {
      id: "canvas-animation",

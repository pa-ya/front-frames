    ...
    },
    {
      ...
      body: [
        ...
        { type: "list", items: [
          ...
          "**Stack-trace clarity:** `abort()` / `RuntimeError: memory access out of bounds` traces show readable, demangled C++ names when you build with `-g` — modern Emscripten demangles automatically (the old `DEMANGLE_SUPPORT` setting was removed). Without debug info you get raw `wasm-function[123]` frames.",
